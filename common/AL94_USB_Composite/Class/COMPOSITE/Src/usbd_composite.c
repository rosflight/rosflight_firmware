...
{ USBD_COMPOSITE_Init, USBD_COMPOSITE_DeInit, USBD_COMPOSITE_Setup, USBD_COMPOSITE_EP0_TxReady, USBD_COMPOSITE_EP0_RxReady, USBD_COMPOSITE_DataIn,
        USBD_COMPOSITE_DataOut, USBD_COMPOSITE_SOF, USBD_COMPOSITE_IsoINIncomplete, USBD_COMPOSITE_IsoOutIncomplete, USBD_COMPOSITE_GetHSCfgDesc,
        USBD_COMPOSITE_GetFSCfgDesc, USBD_COMPOSITE_GetOtherSpeedCfgDesc, USBD_COMPOSITE_GetDeviceQualifierDesc, USBD_COMPOSITE_GetUsrStringDesc };
...
USB_DESC_TYPE_DEVICE_QUALIFIER, 0x00, 0x02, 0xEF, 0x02, 0x01, 0x40, 0x01, 0x00, };
...
void USBD_COMPOSITE_Mount_Class (void)
{
  ...
  USBD_Track_String_Index += 1;
    ...
    USBD_Update_CDC_ACM_DESC (ptr, interface_no_track, interface_no_track + 1, in_ep_track, in_ep_track + 1, out_ep_track, USBD_Track_String_Index);
