...
public:
  ...
  uint32_t gnss_nmea_start_count() const { return gnss_nmea_start_count_; }
  uint32_t gnss_nmea_sentence_count() const { return gnss_nmea_sentence_count_; }
  uint32_t gnss_nmea_gga_count() const { return gnss_nmea_gga_count_; }
  uint32_t gnss_nmea_rmc_count() const { return gnss_nmea_rmc_count_; }
  uint32_t gnss_sample_count() const { return gnss_sample_count_; }
  uint32_t gnss_rx_ring_overflow_count() const { return gnss_rx_ring_overflow_count_; }
  uint32_t gnss_ubx_sync_count() const { return gnss_ubx_sync_count_; }
  ...
  uint8_t gnss_last_byte() const { return gnss_last_byte_; }
  uint8_t gnss_last_frame_class() const { return gnss_last_frame_class_; }
  uint8_t gnss_last_frame_id() const { return gnss_last_frame_id_; }
  ...
  uint64_t gnss_last_nmea_sentence_us() const { return gnss_last_nmea_sentence_us_; }
  uint8_t gnss_fix_type() const { return gnss_fix_type_; }
  uint32_t gnss_ack_count() const { return gnss_ack_count_; }
  uint32_t gnss_nak_count() const { return gnss_nak_count_; }
  uint32_t gnss_ack_timeout_count() const { return gnss_ack_timeout_count_; }
  uint8_t gnss_last_ack_class() const { return gnss_last_ack_class_; }
  uint8_t gnss_last_ack_id() const { return gnss_last_ack_id_; }
  uint8_t gnss_last_nak_class() const { return gnss_last_nak_class_; }
  uint8_t gnss_last_nak_id() const { return gnss_last_nak_id_; }
