...
void MX_TIM12_Init(void)
{
  ...
  htim12.Init.Period = (ADIS165XX_TIM_PERIOD_US);
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(IIS2MDC_CSn_GPIO_Port, IIS2MDC_CSn_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : BMI088_ACCEL_DRDY_Pin BMI088_GYRO_DRDY_Pin J105_3_SYNC_IN_Pin GPS_1PPS_Pin */
  GPIO_InitStruct.Pin = BMI088_ACCEL_DRDY_Pin|BMI088_GYRO_DRDY_Pin|J105_3_SYNC_IN_Pin|GPS_1PPS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  ...
  /*Configure GPIO pin : ADIS165XX_DRDY_Pin */
  GPIO_InitStruct.Pin = ADIS165XX_DRDY_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  HAL_GPIO_Init(ADIS165XX_DRDY_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pin : BMI088_ACCEL_CSn_Pin */
  GPIO_InitStruct.Pin = BMI088_ACCEL_CSn_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  HAL_GPIO_Init(DPS310_DRDY_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : J105_2_SPI4_EXT_CLK_Pin TP5_Pin J105_3_SYNC_OUT_Pin IIS2MDC_CSn_Pin */
  GPIO_InitStruct.Pin = J105_2_SPI4_EXT_CLK_Pin|TP5_Pin|J105_3_SYNC_OUT_Pin|IIS2MDC_CSn_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pin : BMI088_GYRO_CSn_Pin */
  GPIO_InitStruct.Pin = BMI088_GYRO_CSn_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(BMI088_GYRO_CSn_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : ADIS165XX_RESET_Pin */
  GPIO_InitStruct.Pin = ADIS165XX_RESET_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(ADIS165XX_RESET_GPIO_Port, &GPIO_InitStruct);
