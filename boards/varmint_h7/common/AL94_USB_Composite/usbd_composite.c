...
#endif
#if (USBD_USE_HID_MOUSE == 1)
  if (LOBYTE(req->wIndex) == HID_MOUSE_ITF_NBR) { return USBD_HID_MOUSE.Setup(pdev, req); }
#endif
#if (USBD_USE_HID_KEYBOARD == 1)
  if (LOBYTE(req->wIndex) == HID_KEYBOARD_ITF_NBR) { return USBD_HID_KEYBOARD.Setup(pdev, req); }
#endif
#if (USBD_USE_HID_CUSTOM == 1)
  if (LOBYTE(req->wIndex) == CUSTOM_HID_ITF_NBR) { return USBD_HID_CUSTOM.Setup(pdev, req); }
#endif
#if (USBD_USE_UAC_MIC == 1)
...
#endif
#if (USBD_USE_MSC == 1)
  if (LOBYTE(req->wIndex) == MSC_ITF_NBR) { return USBD_MSC.Setup(pdev, req); }
#endif
#if (USBD_USE_DFU == 1)
  if (LOBYTE(req->wIndex) == DFU_ITF_NBR) { return USBD_DFU.Setup(pdev, req); }
#endif
#if (USBD_USE_PRNTR == 1)
  if (LOBYTE(req->wIndex) == PRNT_ITF_NBR) { USBD_PRNT.Setup(pdev, req); }
#endif
...
#endif
#if (USBD_USE_CDC_ECM == 1)
  if (epnum == (CDC_ECM_IN_EP & 0x7F) || epnum == (CDC_ECM_CMD_EP & 0x7F)) { return USBD_CDC_ECM.DataIn(pdev, epnum); }
#endif
#if (USBD_USE_CDC_RNDIS == 1)
...
#endif
#if (USBD_USE_HID_MOUSE == 1)
  if (epnum == (HID_MOUSE_IN_EP & 0x7F)) { return USBD_HID_MOUSE.DataIn(pdev, epnum); }
#endif
#if (USBD_USE_HID_KEYBOARD == 1)
  if (epnum == (HID_KEYBOARD_IN_EP & 0x7F)) { return USBD_HID_KEYBOARD.DataIn(pdev, epnum); }
#endif
#if (USBD_USE_HID_CUSTOM == 1)
  if (epnum == (CUSTOM_HID_IN_EP & 0x7F)) { return USBD_HID_CUSTOM.DataIn(pdev, epnum); }
#endif
#if (USBD_USE_UAC_MIC == 1)
  if (epnum == (AUDIO_MIC_EP & 0x7F)) { return USBD_AUDIO_MIC.DataIn(pdev, epnum); }
#endif
#if (USBD_USE_UAC_SPKR == 1)
#endif
#if (USBD_USE_UVC == 1)
  if (epnum == (UVC_IN_EP & 0x7F)) { return USBD_VIDEO.DataIn(pdev, epnum); }
#endif
#if (USBD_USE_MSC == 1)
  if (epnum == (MSC_IN_EP & 0x7F)) { return USBD_MSC.DataIn(pdev, epnum); }
#endif
#if (USBD_USE_DFU == 1)
#endif
#if (USBD_USE_PRNTR == 1)
  if (epnum == (PRNT_IN_EP & 0x7F)) { USBD_PRNT.DataIn(pdev, epnum); }
#endif
...
#endif
#if (USBD_USE_UAC_MIC == 1)
  if (epnum == (AUDIO_MIC_EP & 0x7F)) { USBD_AUDIO_MIC.IsoINIncomplete(pdev, epnum); }
#endif
#if (USBD_USE_UAC_SPKR == 1)
#endif
#if (USBD_USE_UVC == 1)
  if (epnum == (UVC_IN_EP & 0x7F)) { USBD_VIDEO.IsoINIncomplete(pdev, epnum); }
#endif
#if (USBD_USE_MSC == 1)
#endif
#if (USBD_USE_DFU == 1)
...
#endif
#if (USBD_USE_UAC_SPKR == 1)
  if (epnum == AUDIO_SPKR_EP) { USBD_AUDIO_SPKR.IsoOUTIncomplete(pdev, epnum); }
#endif
#if (USBD_USE_UVC == 1)
#endif
#if (USBD_USE_MSC == 1)
...
#endif
#if (USBD_USE_CDC_ECM == 1)
  if (epnum == CDC_ECM_OUT_EP) { return USBD_CDC_ECM.DataOut(pdev, epnum); }
#endif
#if (USBD_USE_CDC_RNDIS == 1)
  if (epnum == CDC_RNDIS_OUT_EP) { return USBD_CDC_RNDIS.DataOut(pdev, epnum); }
#endif
#if (USBD_USE_HID_MOUSE == 1)
#endif
#if (USBD_USE_HID_KEYBOARD == 1)
#endif
#if (USBD_USE_HID_CUSTOM == 1)
  if (epnum == CUSTOM_HID_OUT_EP) { return USBD_HID_CUSTOM.DataOut(pdev, epnum); }
#endif
#if (USBD_USE_UAC_MIC == 1)
#endif
#if (USBD_USE_UAC_SPKR == 1)
  if (epnum == AUDIO_SPKR_EP) { return USBD_AUDIO_SPKR.DataOut(pdev, epnum); }
#endif
#if (USBD_USE_UVC == 1)
#endif
#if (USBD_USE_MSC == 1)
  if (epnum == MSC_OUT_EP) { return USBD_MSC.DataOut(pdev, epnum); }
#endif
#if (USBD_USE_DFU == 1)
#endif
#if (USBD_USE_PRNTR == 1)
  if (epnum == PRNT_OUT_EP) { USBD_PRNT.DataOut(pdev, epnum); }
#endif
...
#endif
#if (USBD_USE_CDC_ECM == 1)
    if (index == CDC_ECM_STR_DESC_IDX) { USBD_GetString((uint8_t *) CDC_ECM_STR_DESC, USBD_StrDesc, length); }
#endif
#if (USBD_USE_CDC_RNDIS == 1)
    if (index == CDC_RNDIS_STR_DESC_IDX) { USBD_GetString((uint8_t *) CDC_RNDIS_STR_DESC, USBD_StrDesc, length); }
#endif
#if (USBD_USE_HID_MOUSE == 1)
    if (index == HID_MOUSE_STR_DESC_IDX) { USBD_GetString((uint8_t *) HID_MOUSE_STR_DESC, USBD_StrDesc, length); }
#endif
#if (USBD_USE_HID_KEYBOARD == 1)
    if (index == HID_KEYBOARD_STR_DESC_IDX) { USBD_GetString((uint8_t *) HID_KEYBOARD_STR_DESC, USBD_StrDesc, length); }
#endif
#if (USBD_USE_HID_CUSTOM == 1)
    if (index == CUSTOM_HID_STR_DESC_IDX) { USBD_GetString((uint8_t *) CUSTOM_HID_STR_DESC, USBD_StrDesc, length); }
#endif
#if (USBD_USE_UAC_MIC == 1)
    if (index == AUDIO_MIC_STR_DESC_IDX) { USBD_GetString((uint8_t *) AUDIO_MIC_STR_DESC, USBD_StrDesc, length); }
#endif
#if (USBD_USE_UAC_SPKR == 1)
    if (index == AUDIO_SPKR_STR_DESC_IDX) { USBD_GetString((uint8_t *) AUDIO_SPKR_STR_DESC, USBD_StrDesc, length); }
#endif
#if (USBD_USE_UVC == 1)
    if (index == UVC_STR_DESC_IDX) { USBD_GetString((uint8_t *) UVC_STR_DESC, USBD_StrDesc, length); }
#endif
#if (USBD_USE_MSC == 1)
    if (index == MSC_BOT_STR_DESC_IDX) { USBD_GetString((uint8_t *) MSC_BOT_STR_DESC, USBD_StrDesc, length); }
#endif
#if (USBD_USE_DFU == 1)
    if (index == DFU_STR_DESC_IDX) { USBD_GetString((uint8_t *) DFU_STR_DESC, USBD_StrDesc, length); }
#endif
#if (USBD_USE_PRNTR == 1)
    if (index == PRINTER_STR_DESC_IDX) { USBD_GetString((uint8_t *) PRNT_STR_DESC, USBD_StrDesc, length); }
#endif
    return USBD_StrDesc;
  } else {
...
void USBD_COMPOSITE_Mount_Class(void)
{
  ...
  USBD_Update_CDC_RNDIS_DESC(ptr, interface_no_track, interface_no_track + 1, in_ep_track, in_ep_track + 1,
                             out_ep_track, USBD_Track_String_Index);
  ...
  USBD_Update_CDC_ECM_DESC(ptr, interface_no_track, interface_no_track + 1, in_ep_track, in_ep_track + 1, out_ep_track,
  ...
  USBD_Update_Audio_MIC_DESC(ptr, interface_no_track, interface_no_track + 1, in_ep_track, USBD_Track_String_Index);
