...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    PA3     ------> ADC1_INP15
    */
    GPIO_InitStruct.Pin = ADC_RSSI_V_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(ADC_RSSI_V_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = ADC_5V_V_Pin|ADC_BATT_V_Pin|ADC_BATT_I_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA3     ------> ADC1_INP15
    */
    HAL_GPIO_DeInit(ADC_RSSI_V_GPIO_Port, ADC_RSSI_V_Pin);

    HAL_GPIO_DeInit(GPIOA, ADC_5V_V_Pin|ADC_BATT_V_Pin|ADC_BATT_I_Pin);
...
void HAL_I2C_MspInit(I2C_HandleTypeDef* hi2c)
{
  ...
  */
    ...
    */
    ...
    /* I2C1 DMA Init */
    /* I2C1_RX Init */
    hdma_i2c1_rx.Instance = DMA2_Stream2;
    ...
    /* I2C1_TX Init */
    hdma_i2c1_tx.Instance = DMA2_Stream3;
...
void HAL_SD_MspInit(SD_HandleTypeDef* hsd)
{
  ...
  */
    ...
    PC8     ------> SDMMC1_D0
    */
    GPIO_InitStruct.Pin = SDMMC_CK_Pin|SDMMC_D3_Pin|SDMMC_D2_Pin|SDMMC_D1_Pin
                          |SDMMC_D0_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
...
void HAL_SD_MspDeInit(SD_HandleTypeDef* hsd)
{
  ...
  /* USER CODE END SDMMC1_MspDeInit 0 */
    ...
    PC8     ------> SDMMC1_D0
    */
    HAL_GPIO_DeInit(GPIOC, SDMMC_CK_Pin|SDMMC_D3_Pin|SDMMC_D2_Pin|SDMMC_D1_Pin
                          |SDMMC_D0_Pin);
...
void HAL_SPI_MspInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI1_MspInit 0 */
    ...
    PA7     ------> SPI1_MOSI
    */
    GPIO_InitStruct.Pin = ICM_MISO_Pin|ICM_SCK_Pin|ICM_MOSI_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /* USER CODE END SPI2_MspInit 0 */
    ...
    PB15     ------> SPI2_MOSI
    */
    GPIO_InitStruct.Pin = DPS310_FRAM_SCK_Pin|DPS310_FRAM_MISO_Pin|DPS310_FRAM_MOSI_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /* USER CODE END SPI5_MspInit 0 */
    ...
    PF8     ------> SPI5_MISO
    */
    GPIO_InitStruct.Pin = BMI088_SCK_Pin|BMI088_MOSI_Pin|BMI088_MISO_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    ...
    /* SPI5 DMA Init */
    /* SPI5_RX Init */
    hdma_spi5_rx.Instance = DMA1_Stream5;
  ...
  /* USER CODE END SPI6_MspInit 0 */
    ...
    PG12     ------> SPI6_MISO
    */
    GPIO_InitStruct.Pin = SPI6_MOSI_Pin|SPI6_SCK_Pin|SPI6_MISO_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_PULLUP;
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI1_MspDeInit 0 */
    ...
    PA7     ------> SPI1_MOSI
    */
    HAL_GPIO_DeInit(GPIOA, ICM_MISO_Pin|ICM_SCK_Pin|ICM_MOSI_Pin);
  ...
  /* USER CODE END SPI2_MspDeInit 0 */
    ...
    PB15     ------> SPI2_MOSI
    */
    HAL_GPIO_DeInit(GPIOB, DPS310_FRAM_SCK_Pin|DPS310_FRAM_MISO_Pin|DPS310_FRAM_MOSI_Pin);
  ...
  /* USER CODE END SPI5_MspDeInit 0 */
    ...
    PF8     ------> SPI5_MISO
    */
    HAL_GPIO_DeInit(GPIOF, BMI088_SCK_Pin|BMI088_MOSI_Pin|BMI088_MISO_Pin);
  ...
  /* USER CODE END SPI6_MspDeInit 0 */
    ...
    PG12     ------> SPI6_MISO
    */
    HAL_GPIO_DeInit(GPIOG, SPI6_MOSI_Pin|SPI6_SCK_Pin|SPI6_MISO_Pin);
...
void HAL_TIM_PWM_MspInit(TIM_HandleTypeDef* htim_pwm)
{
  ...
  /* USER CODE END TIM8_MspInit 0 */
    ...
    /* TIM8 DMA Init */
    /* TIM8_UP Init */
    hdma_tim8_up.Instance = DMA2_Stream5;
...
void HAL_TIM_IC_MspInit(TIM_HandleTypeDef* htim_ic)
{
  ...
  /* USER CODE END TIM3_MspInit 0 */
    ...
    PB0     ------> TIM3_CH3
    */
    GPIO_InitStruct.Pin = RC_TIM_INPUT_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM3;
    HAL_GPIO_Init(RC_TIM_INPUT_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  /* USER CODE END TIM1_MspPostInit 0 */
    ...
    PE14     ------> TIM1_CH4
    */
    GPIO_InitStruct.Pin = PWM_02_Pin|PWM_04_Pin|PWM_03_Pin|PWM_01_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /* USER CODE END TIM4_MspPostInit 0 */
    ...
    PD13     ------> TIM4_CH2
    */
    GPIO_InitStruct.Pin = PWM_06_Pin|PWM_05_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /* USER CODE END TIM8_MspPostInit 0 */
    ...
    PI5     ------> TIM8_CH1
    */
    GPIO_InitStruct.Pin = PWM_08_Pin|PWM_07_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
...
void HAL_TIM_IC_MspDeInit(TIM_HandleTypeDef* htim_ic)
{
  ...
  /* USER CODE END TIM3_MspDeInit 0 */
    ...
    PB0     ------> TIM3_CH3
    */
    HAL_GPIO_DeInit(RC_TIM_INPUT_GPIO_Port, RC_TIM_INPUT_Pin);
...
void HAL_UART_MspInit(UART_HandleTypeDef* huart)
{
  ...
  */
    ...
    PE7     ------> UART7_RX
    */
    GPIO_InitStruct.Pin = DEBUG_UART7_TX_Pin|DEBUG_UART7_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  */
    ...
    PE0     ------> UART8_RX
    */
    GPIO_InitStruct.Pin = RC_UART8_TX_Pin|RC_UART8_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  */
    ...
    PB6     ------> USART1_TX
    */
    GPIO_InitStruct.Pin = FMU_UART1_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_PULLUP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF7_USART1;
    HAL_GPIO_Init(FMU_UART1_RX_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = FMU_UART1_TX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF7_USART1;
    HAL_GPIO_Init(FMU_UART1_TX_GPIO_Port, &GPIO_InitStruct);
  ...
  */
    ...
    PD5     ------> USART2_TX
    */
    GPIO_InitStruct.Pin = TELEM1_USART2_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_PULLUP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF7_USART2;
    HAL_GPIO_Init(TELEM1_USART2_RX_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = TELEM1_USART2_TX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF7_USART2;
    HAL_GPIO_Init(TELEM1_USART2_TX_GPIO_Port, &GPIO_InitStruct);
  ...
  */
    ...
    PC6     ------> USART6_TX
    */
    GPIO_InitStruct.Pin = RC_USART6_RX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_PULLUP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF7_USART6;
    HAL_GPIO_Init(RC_USART6_RX_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = RC_USART6_TX_NC_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF7_USART6;
    HAL_GPIO_Init(RC_USART6_TX_NC_GPIO_Port, &GPIO_InitStruct);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END UART7_MspDeInit 0 */
    ...
    PE7     ------> UART7_RX
    */
    HAL_GPIO_DeInit(GPIOE, DEBUG_UART7_TX_Pin|DEBUG_UART7_RX_Pin);
  ...
  /* USER CODE END UART8_MspDeInit 0 */
    ...
    PE0     ------> UART8_RX
    */
    HAL_GPIO_DeInit(GPIOE, RC_UART8_TX_Pin|RC_UART8_RX_Pin);
  ...
  /* USER CODE END USART1_MspDeInit 0 */
    ...
    PB6     ------> USART1_TX
    */
    HAL_GPIO_DeInit(GPIOB, FMU_UART1_RX_Pin|FMU_UART1_TX_Pin);
  ...
  /* USER CODE END USART2_MspDeInit 0 */
    ...
    PD5     ------> USART2_TX
    */
    HAL_GPIO_DeInit(GPIOD, TELEM1_USART2_RX_Pin|TELEM1_USART2_TX_Pin);
  ...
  /* USER CODE END USART6_MspDeInit 0 */
    ...
    PC6     ------> USART6_TX
    */
    HAL_GPIO_DeInit(GPIOC, RC_USART6_RX_Pin|RC_USART6_TX_NC_Pin);
