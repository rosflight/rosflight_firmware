...
#define MAVLINK_MSG_ID_ROSFLIGHT_CMD_ACK_MIN_LEN 2
#define MAVLINK_MSG_ID_189_LEN 2
#define MAVLINK_MSG_ID_189_MIN_LEN 2
                               ...
                               uint8_t command, uint8_t success)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_ROSFLIGHT_CMD_ACK_MIN_LEN, MAVLINK_MSG_ID_ROSFLIGHT_CMD_ACK_LEN, MAVLINK_MSG_ID_ROSFLIGHT_CMD_ACK_CRC);
}
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_rosflight_cmd_ack_pack_status(uint8_t system_id, uint8_t component_id, mavlink_status_t *_status, mavlink_message_t* msg,
                               uint8_t command, uint8_t success)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_ROSFLIGHT_CMD_ACK_LEN];
    ...
    return mavlink_finalize_message_buffer(msg, system_id, component_id, _status, MAVLINK_MSG_ID_ROSFLIGHT_CMD_ACK_MIN_LEN, MAVLINK_MSG_ID_ROSFLIGHT_CMD_ACK_LEN, MAVLINK_MSG_ID_ROSFLIGHT_CMD_ACK_CRC);
#else
    return mavlink_finalize_message_buffer(msg, system_id, component_id, _status, MAVLINK_MSG_ID_ROSFLIGHT_CMD_ACK_MIN_LEN, MAVLINK_MSG_ID_ROSFLIGHT_CMD_ACK_LEN);
#endif
}
                                   ...
                                   uint8_t command,uint8_t success)
{
    ...
    msg->msgid = MAVLINK_MSG_ID_ROSFLIGHT_CMD_ACK;
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_ROSFLIGHT_CMD_ACK_MIN_LEN, MAVLINK_MSG_ID_ROSFLIGHT_CMD_ACK_LEN, MAVLINK_MSG_ID_ROSFLIGHT_CMD_ACK_CRC);
}
...
/**
 * @brief Encode a rosflight_cmd_ack struct with provided status structure
 *
 * @param system_id ID of this system
 * @param component_id ID of this component (e.g. 200 for IMU)
 * @param status MAVLink status structure
 ...
 * @param rosflight_cmd_ack C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_rosflight_cmd_ack_encode_status(uint8_t system_id, uint8_t component_id, mavlink_status_t* _status, mavlink_message_t* msg, const mavlink_rosflight_cmd_ack_t* rosflight_cmd_ack)
{
    return mavlink_msg_rosflight_cmd_ack_pack_status(system_id, component_id, _status, msg,  rosflight_cmd_ack->command, rosflight_cmd_ack->success);
}
...
static inline void mavlink_msg_rosflight_cmd_ack_send(mavlink_channel_t chan, uint8_t command, uint8_t success)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ROSFLIGHT_CMD_ACK, buf, MAVLINK_MSG_ID_ROSFLIGHT_CMD_ACK_MIN_LEN, MAVLINK_MSG_ID_ROSFLIGHT_CMD_ACK_LEN, MAVLINK_MSG_ID_ROSFLIGHT_CMD_ACK_CRC);
#else
    mavlink_rosflight_cmd_ack_t packet;
    packet.command = command;
    packet.success = success;

    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ROSFLIGHT_CMD_ACK, (const char *)&packet, MAVLINK_MSG_ID_ROSFLIGHT_CMD_ACK_MIN_LEN, MAVLINK_MSG_ID_ROSFLIGHT_CMD_ACK_LEN, MAVLINK_MSG_ID_ROSFLIGHT_CMD_ACK_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_rosflight_cmd_ack_send_struct(mavlink_channel_t chan, const mavlink_rosflight_cmd_ack_t* rosflight_cmd_ack)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_rosflight_cmd_ack_send(chan, rosflight_cmd_ack->command, rosflight_cmd_ack->success);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ROSFLIGHT_CMD_ACK, (const char *)rosflight_cmd_ack, MAVLINK_MSG_ID_ROSFLIGHT_CMD_ACK_MIN_LEN, MAVLINK_MSG_ID_ROSFLIGHT_CMD_ACK_LEN, MAVLINK_MSG_ID_ROSFLIGHT_CMD_ACK_CRC);
#endif
}
...
#else
        uint8_t len = msg->len < MAVLINK_MSG_ID_ROSFLIGHT_CMD_ACK_LEN? msg->len : MAVLINK_MSG_ID_ROSFLIGHT_CMD_ACK_LEN;
        memset(rosflight_cmd_ack, 0, MAVLINK_MSG_ID_ROSFLIGHT_CMD_ACK_LEN);
    memcpy(rosflight_cmd_ack, _MAV_PAYLOAD(msg), len);
#endif
}
