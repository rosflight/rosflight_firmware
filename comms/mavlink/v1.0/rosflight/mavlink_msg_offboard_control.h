...
{
    return mavlink_msg_offboard_control_pack_status(system_id, component_id, _status, msg,  offboard_control->mode, offboard_control->ignore, offboard_control->Qx, offboard_control->Qy, offboard_control->Qz, offboard_control->Fx, offboard_control->Fy, offboard_control->Fz);
}
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_offboard_control_send(chan, offboard_control->mode, offboard_control->ignore, offboard_control->Qx, offboard_control->Qy, offboard_control->Qz, offboard_control->Fx, offboard_control->Fy, offboard_control->Fz);
#else
