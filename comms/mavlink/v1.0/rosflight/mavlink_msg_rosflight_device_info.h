// MESSAGE ROSFLIGHT_DEVICE_INFO PACKING
...
/**
 * @brief Pack a rosflight_device_info message
						       ...
						       uint8_t device, uint8_t max_config, const uint8_t *name, uint8_t num_devices)
{
	...
	msg->msgid = MAVLINK_MSG_ID_ROSFLIGHT_DEVICE_INFO;
#if MAVLINK_CRC_EXTRA
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_ROSFLIGHT_DEVICE_INFO_LEN, MAVLINK_MSG_ID_ROSFLIGHT_DEVICE_INFO_CRC);
#else
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_ROSFLIGHT_DEVICE_INFO_LEN);
#endif
}

/**
 * @brief Pack a rosflight_device_info message on a channel
 * @param system_id ID of this system
 * @param component_id ID of this component (e.g. 200 for IMU)
						           ...
						           uint8_t device,uint8_t max_config,const uint8_t *name,uint8_t num_devices)
{
	...
	msg->msgid = MAVLINK_MSG_ID_ROSFLIGHT_DEVICE_INFO;
#if MAVLINK_CRC_EXTRA
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_ROSFLIGHT_DEVICE_INFO_LEN, MAVLINK_MSG_ID_ROSFLIGHT_DEVICE_INFO_CRC);
#else
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_ROSFLIGHT_DEVICE_INFO_LEN);
#endif
}

/**
 * @brief Encode a rosflight_device_info struct
 *
 * @param system_id ID of this system
 * @param component_id ID of this component (e.g. 200 for IMU)
 * @param msg The MAVLink message to compress the data into
 * @param rosflight_device_info C-struct to read the message contents from
 */
...
/**
 * @brief Encode a rosflight_device_info struct on a channel
 *
 * @param system_id ID of this system
 * @param component_id ID of this component (e.g. 200 for IMU)
 * @param chan The MAVLink channel this message will be sent over
...
/**
 * @brief Send a rosflight_device_info message
...
static inline void mavlink_msg_rosflight_device_info_send(mavlink_channel_t chan, uint8_t device, uint8_t max_config, const uint8_t *name, uint8_t num_devices)
{
	...
	_mav_put_uint8_t_array(buf, 2, name, 20);
#if MAVLINK_CRC_EXTRA
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ROSFLIGHT_DEVICE_INFO, buf, MAVLINK_MSG_ID_ROSFLIGHT_DEVICE_INFO_LEN, MAVLINK_MSG_ID_ROSFLIGHT_DEVICE_INFO_CRC);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ROSFLIGHT_DEVICE_INFO, buf, MAVLINK_MSG_ID_ROSFLIGHT_DEVICE_INFO_LEN);
#endif
#else
	mavlink_rosflight_device_info_t packet;
	packet.device = device;
	...
	mav_array_memcpy(packet.name, name, sizeof(uint8_t)*20);
#if MAVLINK_CRC_EXTRA
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ROSFLIGHT_DEVICE_INFO, (const char *)&packet, MAVLINK_MSG_ID_ROSFLIGHT_DEVICE_INFO_LEN, MAVLINK_MSG_ID_ROSFLIGHT_DEVICE_INFO_CRC);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_ROSFLIGHT_DEVICE_INFO, (const char *)&packet, MAVLINK_MSG_ID_ROSFLIGHT_DEVICE_INFO_LEN);
#endif
#endif
}

#if MAVLINK_MSG_ID_ROSFLIGHT_DEVICE_INFO_LEN <= MAVLINK_MAX_PAYLOAD_LEN
/*
...
// MESSAGE ROSFLIGHT_DEVICE_INFO UNPACKING


/**
 * @brief Get field device from rosflight_device_info message
 *
 * @return 
 */
static inline uint8_t mavlink_msg_rosflight_device_info_get_device(const mavlink_message_t* msg)
{
...
/**
 * @brief Get field name from rosflight_device_info message
 *
 * @return 
 */
static inline uint16_t mavlink_msg_rosflight_device_info_get_name(const mavlink_message_t* msg, uint8_t *name)
{
	return _MAV_RETURN_uint8_t_array(msg, name, 20,  2);
}

/**
 * @brief Get field num_devices from rosflight_device_info message
 *
 * @return 
 */
static inline uint8_t mavlink_msg_rosflight_device_info_get_num_devices(const mavlink_message_t* msg)
{
	return _MAV_RETURN_uint8_t(msg,  22);
}

/**
 * @brief Decode a rosflight_device_info message into a struct
 *
 * @param msg The message to decode
 * @param rosflight_device_info C-struct to decode the message contents into
 */
static inline void mavlink_msg_rosflight_device_info_decode(const mavlink_message_t* msg, mavlink_rosflight_device_info_t* rosflight_device_info)
{
...
#else
	memcpy(rosflight_device_info, _MAV_PAYLOAD(msg), MAVLINK_MSG_ID_ROSFLIGHT_DEVICE_INFO_LEN);
#endif
}
