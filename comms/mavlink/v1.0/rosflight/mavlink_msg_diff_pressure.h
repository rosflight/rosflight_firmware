...
#define MAVLINK_MSG_ID_DIFF_PRESSURE_MIN_LEN 12
#define MAVLINK_MSG_ID_184_LEN 12
#define MAVLINK_MSG_ID_184_MIN_LEN 12
                               ...
                               float velocity, float diff_pressure, float temperature)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_DIFF_PRESSURE_MIN_LEN, MAVLINK_MSG_ID_DIFF_PRESSURE_LEN, MAVLINK_MSG_ID_DIFF_PRESSURE_CRC);
}
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_diff_pressure_pack_status(uint8_t system_id, uint8_t component_id, mavlink_status_t *_status, mavlink_message_t* msg,
                               float velocity, float diff_pressure, float temperature)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_DIFF_PRESSURE_LEN];
    ...
    return mavlink_finalize_message_buffer(msg, system_id, component_id, _status, MAVLINK_MSG_ID_DIFF_PRESSURE_MIN_LEN, MAVLINK_MSG_ID_DIFF_PRESSURE_LEN, MAVLINK_MSG_ID_DIFF_PRESSURE_CRC);
#else
    return mavlink_finalize_message_buffer(msg, system_id, component_id, _status, MAVLINK_MSG_ID_DIFF_PRESSURE_MIN_LEN, MAVLINK_MSG_ID_DIFF_PRESSURE_LEN);
#endif
}
                                   ...
                                   float velocity,float diff_pressure,float temperature)
{
    ...
    msg->msgid = MAVLINK_MSG_ID_DIFF_PRESSURE;
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_DIFF_PRESSURE_MIN_LEN, MAVLINK_MSG_ID_DIFF_PRESSURE_LEN, MAVLINK_MSG_ID_DIFF_PRESSURE_CRC);
}
...
/**
 * @brief Encode a diff_pressure struct with provided status structure
 *
 * @param system_id ID of this system
 * @param component_id ID of this component (e.g. 200 for IMU)
 * @param status MAVLink status structure
 ...
 * @param diff_pressure C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_diff_pressure_encode_status(uint8_t system_id, uint8_t component_id, mavlink_status_t* _status, mavlink_message_t* msg, const mavlink_diff_pressure_t* diff_pressure)
{
    return mavlink_msg_diff_pressure_pack_status(system_id, component_id, _status, msg,  diff_pressure->velocity, diff_pressure->diff_pressure, diff_pressure->temperature);
}
...
static inline void mavlink_msg_diff_pressure_send(mavlink_channel_t chan, float velocity, float diff_pressure, float temperature)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_DIFF_PRESSURE, buf, MAVLINK_MSG_ID_DIFF_PRESSURE_MIN_LEN, MAVLINK_MSG_ID_DIFF_PRESSURE_LEN, MAVLINK_MSG_ID_DIFF_PRESSURE_CRC);
#else
    mavlink_diff_pressure_t packet;
    packet.velocity = velocity;
    packet.diff_pressure = diff_pressure;
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_DIFF_PRESSURE, (const char *)&packet, MAVLINK_MSG_ID_DIFF_PRESSURE_MIN_LEN, MAVLINK_MSG_ID_DIFF_PRESSURE_LEN, MAVLINK_MSG_ID_DIFF_PRESSURE_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_diff_pressure_send_struct(mavlink_channel_t chan, const mavlink_diff_pressure_t* diff_pressure)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_diff_pressure_send(chan, diff_pressure->velocity, diff_pressure->diff_pressure, diff_pressure->temperature);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_DIFF_PRESSURE, (const char *)diff_pressure, MAVLINK_MSG_ID_DIFF_PRESSURE_MIN_LEN, MAVLINK_MSG_ID_DIFF_PRESSURE_LEN, MAVLINK_MSG_ID_DIFF_PRESSURE_CRC);
#endif
}
...
#else
        uint8_t len = msg->len < MAVLINK_MSG_ID_DIFF_PRESSURE_LEN? msg->len : MAVLINK_MSG_ID_DIFF_PRESSURE_LEN;
        memset(diff_pressure, 0, MAVLINK_MSG_ID_DIFF_PRESSURE_LEN);
    memcpy(diff_pressure, _MAV_PAYLOAD(msg), len);
#endif
}
