...
void set_param_defaults(void)
{
  ...
  init_param(PARAM_GYRO_X_BIAS, "PARAM_GYRO_X_BIAS", -20);
  init_param(PARAM_GYRO_Y_BIAS, "PARAM_GYRO_Y_BIAS", 5);
  init_param(PARAM_GYRO_Z_BIAS, "PARAM_GYRO_Z_BIAS", 6);
  init_param(PARAM_ACC_X_BIAS, "PARAM_ACC_X_BIAS", -110);
  init_param(PARAM_ACC_Y_BIAS, "PARAM_ACC_Y_BIAS", 50);
  init_param(PARAM_ACC_Z_BIAS, "PARAM_ACC_Z_BIAS", 46);

  init_param(PARAM_MOTOR_PWM_SEND_RATE, "MOTOR_PWM_SEND_RATE", 50);
  init_param(PARAM_MOTOR_IDLE_PWM, "MOTOR_IDLE_PWM", 1100);
  init_param(PARAM_SPIN_MOTORS_WHEN_ARMED, "SPIN_MOTORS_WHEN_ARMED", true);
  ...
  init_param(PARAM_RC_ATT_CONTROL_TYPE_CHANNEL, "RC_ATT_CONTROL_TYPE_CHANNEL", 6);
  init_param(PARAM_RC_F_CONTROL_TYPE_CHANNEL, "RC_F_CONTROL_TYPE_CHANNEL", 6);
  ...
  init_param(PARAM_MAX_COMMAND, "PARAM_MAX_COMMAND", 1000);

  init_param(PARAM_PID_ROLL_RATE_P, "PARAM_PID_ROLL_RATE_P", 400);
  init_param(PARAM_MAX_ROLL_RATE, "PARAM_MAX_ROLL_RATE", 12566);

  init_param(PARAM_PID_PITCH_RATE_P, "PARAM_PID_PITCH_RATE_P", 400);
  ...
  init_param(PARAM_PID_ROLL_ANGLE_P, "PARAM_PID_ROLL_ANGLE_P", 2000);
  init_param(PARAM_PID_ROLL_ANGLE_I, "PARAM_PID_ROLL_ANGLE_I", 0);
  init_param(PARAM_PID_ROLL_ANGLE_D, "PARAM_PID_ROLL_ANGLE_D", 0);
  init_param(PARAM_MAX_ROLL_ANGLE, "PARAM_MAX_ROLL_ANGLE", 786);

  init_param(PARAM_PID_PITCH_ANGLE_P, "PARAM_PID_PITCH_ANGLE_P", 2000);
  init_param(PARAM_PID_PITCH_ANGLE_I, "PARAM_PID_PITCH_ANGLE_I", 0);
  init_param(PARAM_PID_PITCH_ANGLE_D, "PARAM_PID_PITCH_ANGLE_D", 0);
  init_param(PARAM_MAX_PITCH_ANGLE, "PARAM_MAX_PITCH_ANGLE", 786);

  init_param(PARAM_PID_ALT_P, "PARAM_PID_ALT_P", 10);
