...
void set_param_defaults(void)
{
  ...
  init_param(PARAM_PID_ROLL_RATE_P, "PARAM_PID_ROLL_RATE_P", 1000);
  init_param(PARAM_MAX_ROLL_RATE, "PARAM_MAX_ROLL_RATE", 1000);

  init_param(PARAM_PID_PITCH_RATE_P, "PARAM_PID_PITCH_RATE_P", 1000);
  init_param(PARAM_MAX_PITCH_RATE, "PARAM_MAX_PITCH_RATE", 1000);

  init_param(PARAM_PID_YAW_RATE_P, "PARAM_PID_YAW_RATE_P", 1000);
  init_param(PARAM_PID_YAW_RATE_I, "PARAM_PID_YAW_RATE_I", 10);
  init_param(PARAM_MAX_YAW_RATE, "PARAM_MAX_YAW_RATE", 1000);

  init_param(PARAM_PID_ROLL_ANGLE_P, "PARAM_PID_ROLL_ANGLE_P", 1000);
  init_param(PARAM_PID_ROLL_ANGLE_I, "PARAM_PID_ROLL_ANGLE_I", 1);
  init_param(PARAM_PID_ROLL_ANGLE_D, "PARAM_PID_ROLL_ANGLE_D", 1000);
  init_param(PARAM_MAX_ROLL_ANGLE, "PARAM_MAX_ROLL_ANGLE", 1000);

  init_param(PARAM_PID_PITCH_ANGLE_P, "PARAM_PID_PITCH_ANGLE_P", 1000);
  init_param(PARAM_PID_PITCH_ANGLE_I, "PARAM_PID_PITCH_ANGLE_I", 1000);
  init_param(PARAM_PID_PITCH_ANGLE_D, "PARAM_PID_PITCH_ANGLE_D", 1000);
  init_param(PARAM_MAX_PITCH_ANGLE, "PARAM_MAX_PITCH_ANGLE", 1000);

  init_param(PARAM_PID_ALT_P, "PARAM_PID_ALT_P", 1000);
  init_param(PARAM_PID_ALT_I, "PARAM_PID_ALT_I", 1000);
  init_param(PARAM_PID_ALT_D, "PARAM_PID_ALT_D", 1000);
