...
void set_param_defaults(void)
{
  ...
  init_param(PARAM_PID_ROLL_RATE_P, "PARAM_PID_ROLL_RATE_P", (12566*1000)/(2*786));
  ...
  init_param(PARAM_PID_ROLL_ANGLE_P, "PARAM_PID_ROLL_ANGLE_P", 100);
  ...
  init_param(PARAM_PID_PITCH_ANGLE_P, "PARAM_PID_PITCH_ANGLE_P", 100);
