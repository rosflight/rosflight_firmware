...
void set_param_defaults(void)
{
  ...
  init_param(PARAM_PID_ROLL_RATE_P, "PARAM_PID_ROLL_RATE_P", 100);
  init_param(PARAM_MAX_ROLL_RATE, "PARAM_MAX_ROLL_RATE", 12566);

  init_param(PARAM_PID_PITCH_RATE_P, "PARAM_PID_PITCH_RATE_P", 0);
  ...
  init_param(PARAM_PID_PITCH_ANGLE_P, "PARAM_PID_PITCH_ANGLE_P", 0);
