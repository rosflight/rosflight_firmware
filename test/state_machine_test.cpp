...
TEST(StateManagerTest, StartPreflight)
{
    testBoard board;
...
TEST(StateManagerTest, SetClearAllErrors)
{
    testBoard board;
    Mavlink mavlink(board);
    ROSflight rf(board, mavlink);
...
TEST(StateManagerTest, ErrorCombo)
{
    testBoard board;
    Mavlink mavlink(board);
    ROSflight rf(board, mavlink);
...
TEST(StateManagerTest, AddError)
{
    testBoard board;
    Mavlink mavlink(board);
    ROSflight rf(board, mavlink);
...
TEST(StateManagerTest, ClearOneError)
{
    testBoard board;
    Mavlink mavlink(board);
    ROSflight rf(board, mavlink);
...
TEST(StateManagerTest, ArmWithoutErrors)
{
    testBoard board;
    Mavlink mavlink(board);
    ROSflight rf(board, mavlink);
...
TEST(StateManagerTest, DontArmWithErrors)
{
    testBoard board;
    Mavlink mavlink(board);
    ROSflight rf(board, mavlink);
...
TEST(StateManagerTest, ArmAfterClearingErrors)
{
    testBoard board;
    Mavlink mavlink(board);
    ROSflight rf(board, mavlink);
...
TEST(StateManagerTest, DontArmImmediatelyWithGyroCal)
{
    testBoard board;
    Mavlink mavlink(board);
    ROSflight rf(board, mavlink);
...
TEST(StateManagerTest, ArmAfterGyroCal)
{
    testBoard board;
    Mavlink mavlink(board);
    ROSflight rf(board, mavlink);
